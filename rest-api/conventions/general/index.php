...
<p><pre><?php echo $apiDomain; ?>/v1/</pre></p>
...
<p><pre>
<?php echo $apiDomain; ?>/v1/{resource}.json
...
needs to make cross-domain requests to the WizeHive API without using a proxy or the more modern 
<a href="/rest-api/cross-origin-resource-sharing">Cross-Origin Resource Sharing (CORS)</a> strategy.</p>

<p>Example:</p>

<p><pre>
<?php echo $apiDomain; ?>/v1/{resource}.json?callback=foo
