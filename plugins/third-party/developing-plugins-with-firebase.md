...
The Firebase JavaScript client v1.0.17 and [AngularFire v0.8.0]({{site.baseurl}}/libraries/angularfire/0.8.0/){:target="_blank"} is available to all plugin developers. Use it to store and sync data in realtime.
